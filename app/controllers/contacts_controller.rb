class ContactsController < ApplicationController
  ...
  def create
    ...
    if @contact.tout
      ...
      @contact.emails = ["contact@samandco-tp.com", "julien.nc14@gmail.com", "aze2j@live.fr", "poncetemilien@hotmail.fr", "f.lefortier@gmail.com", "stephmatt.carrelage@aliceadsl.fr", "benoit.briere@logikinov.com", "a.lefrancois@rlamenagement.com", "profil@profil-amenagement.com", "contact@benoist.fr", "romain.picant@orange.fr"]
  ...
  def contact_params
    params.require(:contact).permit(:name, :email, :address, :phone, :message, :tout, :plombier, :electricite, :peinture, :carrelage, :cheminee, :menuiserie, :couverture, :agencement, :plaquiste, :maconnerie, :terrassement2, :chauffagiste)
  end
end
